...
import com.github.wechat.ilink.bot.mode.AutogameMode;
import com.github.wechat.ilink.bot.mode.ChatMode;
import com.github.wechat.ilink.bot.mode.ClaudeBridgeMode;
import com.github.wechat.ilink.bot.mode.ModeContext;
import com.github.wechat.ilink.bot.mode.ModeOutcome;
import com.github.wechat.ilink.bot.mode.MediaDownloader;
import com.github.wechat.ilink.bot.mode.ModeRouter;
import com.github.wechat.ilink.bot.mode.ModeSender;
import com.github.wechat.ilink.bot.mode.RateLimiter;
import com.github.wechat.ilink.bot.mode.ReviewMode;
import com.github.wechat.ilink.bot.mode.RetrySender;
import com.github.wechat.ilink.bot.mode.SystemCommandMode;
import com.github.wechat.ilink.bot.mode.FarmMode;
...
import com.github.wechat.ilink.bot.mode.hook.InboundAuditHook;
import com.github.wechat.ilink.bot.mode.hook.OutboundAuditHook;
...
public class GameBot implements OnMessageListener, ModeSender, MediaDownloader {
    ...
    public GameBot(GameEngine engine, ResponseRenderer renderer,
        ...
        HookConfig hookConfig = HookConfig.load("data/hooks-config.json");
